...
USAGE:
    bttf time in <time-zone> <datetime>...
    bttf time in <time-zone> < line delimited <datetime>
    bttf time in <datetime> <time-zone>...
    bttf time in <datatime> < line delimited <time-zone>
...
EXAMPLES:
    ...
    arguments leads to equivalent results:
        ...
        bttf time in now Pacific/Honolulu
    ...
    time zones:
        ...
        $ bttf time in now Pacific/Honolulu Israel Asia/Kolkata US/Eastern
