...
USAGE:
    bttf time round <datetime>...
    bttf time round < line delimited <datetime>
...
EXAMPLES:
    Round a datetime to the nearest day:
        ...
        $ bttf time round -s day 2025-03-05T12:01
    ...
    Round a datetime to the nearest day via truncation:
        ...
        $ bttf time round -s day -m trunc 2025-03-05T12:01
        2025-03-06T00:00:00-05:00[America/New_York]

    Round a datetime to the nearest half-hour:

        $ bttf time round -s minute -i 30 2025-03-05T12:15
    ...
    where as it would typically round up (using the default rounding mode):
        ...
        $ bttf time round -s day '2025-03-09T12:15[America/New_York]'
        2025-03-09T00:00:00-05:00[America/New_York]

    bttf also tries to do the intuitive thing when rounding within daylight
    saving time transitions. For example, bttf knows to round to the nearest
    ...
    twice):
        ...
        $ bttf time round -sminute -i30 '2025-11-02T01:29-04[America/New_York]'
        2025-11-02T01:30:00-04:00[America/New_York]
        $ bttf time round -sminute -i30 '2025-11-02T01:29-05[America/New_York]'
