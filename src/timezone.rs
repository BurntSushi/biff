    ...
    static IDS: LazyLock<Vec<String>> = LazyLock::new(|| {
        let mut names: Vec<String> = jiff::tz::db()
            ...
            .filter_map(|name| {
                ...
                // present and bttf will happily accept them. But they usually
...
bttf accepts a few different formats for time zones automatically. They fall
...
automatically detected by bttf from your system's configuration. On Unix
